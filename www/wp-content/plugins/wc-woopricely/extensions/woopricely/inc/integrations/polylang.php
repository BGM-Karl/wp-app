...
if ( !class_exists( 'WCWooPricely_Polylang' ) && class_exists( 'Polylang' ) ) {

    class WCWooPricely_Polylang {
        ...
        private function register_string( $string_id, $string_value, $is_multiline = true ) {
            ...
            if ( function_exists( 'icl_register_string' ) ) {
                ...
                pll_register_string( $string_id, $string_value, 'zcpri-woopricely', $is_multiline );
            }
        }
